<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebApplication2.kurumsaluser.index" EnableEventValidation="false" %>
                ...
                <p class="login-box-msg">Lütfen Giriş Yapınız</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            ...
                            <div class="form-group">
                                <div class="alert alert-danger alert-dismissable">
                                    ...
                                    Doğru Kullanıcı Adı veya Şifre Giriniz...
                                </div>
                            </div>
                        </asp:Panel>
                        </div>
                        ...
                        <div class="col-xs-4">
                         ...
                         <div class="col-xs-4">
                            <asp:Button runat="server" type="submit" ID="Button2" CssClass="btn btn-primary btn-block btn-flat" Text="Kaydol" OnClick="Button2_Click" />
                        </div>
                        <div class="col-xs-4">
                            <asp:Button runat="server" type="submit" ID="bt3" CssClass="btn btn-primary btn-block btn-flat" Text="Hatırlat" OnClick="bt3_Click" />
                        </div>
                        <!-- /.col -->
                    </div>
